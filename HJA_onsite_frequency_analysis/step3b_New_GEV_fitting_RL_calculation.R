...
library(plotly)
library(mkac)
site=list.files("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Annual_Maxima/use/")
for (s in 1:3){
files=list.files(paste0("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Annual_Maxima/use/",site[s],"/"))
print(site[s])
for(m in 1:length(files)){
  print(files[m])
  out=as.data.frame(read.table(paste0("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Annual_Maxima/use/",site[s],"/",files[m]),fill=TRUE))
  z=which(out[,1]<2019)
  out=out[z,]
  #out=out[3:47,]
  ...
  x=seq(2,500,by=1)
  rlmom=cbind(x,rlmom)
  write.table(rlmom, paste0("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Return_Level_GEV/",site[s],"/Lmoments/",files[m]),row.names=FALSE, col.names=FALSE)
  #parl=ci(fitlmom, alpha = 0.1, type = c("parameter"),which.par, R = 1000)
  #write.table(parl, paste0("G:/Sourav/USFS/Revised/HJ Andrews/GEV_parameters/Lmoments/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(cbind(x,rls), paste0("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Return_Level_GEV/",site[s],"/NS_bayesian/RL_s/",files[m]),row.names=FALSE, col.names=FALSE);  
  ...
  write.table(dic_out, paste0("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Return_Level_GEV/",site[s],"/NS_bayesian/DIC/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(outrl, paste0("G:/Sourav/USFS/Revised/HJ Andrews/data_for_Reg_FA/ONSITE/Return_Level_GEV/",site[s],"/NS_bayesian/RL_ns/",files[m]),row.names=FALSE, col.names=FALSE)
