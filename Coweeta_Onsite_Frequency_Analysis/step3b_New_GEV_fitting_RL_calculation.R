...
for(m in 1:length(files)){
  print(files[m])
  out=as.data.frame(read.table(paste0("G:/Sourav/USFS/Revised/Coweeta/Annual_Maxima_Series/",files[m]),fill=TRUE))
  out[,2]=out[,2]*2.54
  ...
  x=seq(2,500,by=1)
  rlmom=cbind(x,rlmom)
  write.table(rlmom, paste0("G:/Sourav/USFS/Revised/Coweeta/Return_Level_GEV/Lmoments/",files[m]),row.names=FALSE, col.names=FALSE)
  #parl=ci(fitlmom, alpha = 0.1, type = c("parameter"),which.par, R = 1000)
  #write.table(parl, paste0("G:/Sourav/USFS/Revised/Coweeta/GEV_parameters/Lmoments/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(cbind(x,rls), paste0("G:/Sourav/USFS/Revised/Coweeta/Return_Level_GEV/NS_bayesian/RL_s/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(dic_out, paste0("G:/Sourav/USFS/Revised/Coweeta/Return_Level_GEV/NS_bayesian/DIC/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(outrl, paste0("G:/Sourav/USFS/Revised/Coweeta/Return_Level_GEV/NS_bayesian/RL_ns/",files[m]),row.names=FALSE, col.names=FALSE)
