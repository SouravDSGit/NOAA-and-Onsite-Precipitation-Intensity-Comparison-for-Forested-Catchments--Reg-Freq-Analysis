...
for(m in 1:length(files)){
  ...
  x=seq(2,500,by=1)
  rlmom=cbind(x,rlmom)
  write.table(rlmom, paste0("G:/Sourav/USFS/Revised/Santee/Return_Level_GEV/Lmoments/",files[m]),row.names=FALSE, col.names=FALSE)
  #parl=ci(fitlmom, alpha = 0.1, type = c("parameter"),which.par, R = 1000)
  #write.table(parl, paste0("G:/Sourav/USFS/Revised/Santee/GEV_parameters/Lmoments/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(cbind(x,rls), paste0("G:/Sourav/USFS/Revised/Santee/Return_Level_GEV/NS_bayesian/RL_s/",files[m]),row.names=FALSE, col.names=FALSE)
  ...
  write.table(outrl, paste0("G:/Sourav/USFS/Revised/Santee/Return_Level_GEV/NS_bayesian/RL_ns/",files[m]),row.names=FALSE, col.names=FALSE)
